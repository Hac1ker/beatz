    ...
    for (const song of songs) {
        songul.innerHTML += ` <li class="flex align_i pointer">
                                ...
                                <div class="play flex gap align_i">
                                    <span>Play Now</span>
                                    <img src="img/play.webp" class="pointer" alt="Click me">
                                </div>
                            </li>`;
    }
    ...
    for (let index = 0; index < array.length; index++) {
        ...
        if (e.href.includes("/songs")) {
            ...
            cardcont.innerHTML = cardcont.innerHTML + `<div data-folder="${folders}" class="card pointer rounded">
                        ...
                        <img src="/songs/${folders}/cover.png" alt="Be Happy" class="rounded">
...
async function main() {
    ...
    hamburger.addEventListener("click", () => {
        ...
        if (hamburger.src.includes("hamburger.webp")) {
            leftBar.style.left = "0";
            hamburger.src = "img/cross.webp";
        } else {
            leftBar.style.left = "-200%";
            hamburger.src = "img/hamburger.webp";
        }
    });
    ...
    document.querySelector(".volumecont > img").addEventListener("click", (e) => {
        if (e.target.src.endsWith("img/volume.webp")) {
            e.target.src = "img/mute.webp";
            currentSong.volume = 0;
            document.querySelector(".volume").getElementsByTagName("input")[0].value = 0;
        } else {
            e.target.src = "img/volume.webp";
